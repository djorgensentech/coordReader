...
class CoordReaderApp:
    def __init__(self, master):
        ...
        self.master.geometry("250x160")  # Set default window size

        # Get the path to the bundled icon file
        icon_path = os.path.join(sys._MEIPASS, "coords.ico") if hasattr(sys, '_MEIPASS') else "coords.ico"
